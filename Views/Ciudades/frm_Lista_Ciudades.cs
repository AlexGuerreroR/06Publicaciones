...
namespace _06Publicaciones.Views.Ciudades
{
    public partial class frm_Lista_Ciudades : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'pubsDataSet2.Paises' Puede moverla o quitarla según sea necesario.
            this.paisesTableAdapter1.Fill(this.pubsDataSet2.Paises);
